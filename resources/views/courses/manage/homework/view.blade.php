...
<div class="container mundb-standard-container">
    ...
    <h5 class="atsast-title-h5">作业提交</h5>
    <div id="accordion" class="mb-5">
        <{foreach $homework_submit as $h }>
        <card class="p-0">
            ...
            <div id="collapse<{$h['uid']}>" class="collapse" aria-labelledby="heading<{$h['uid']}>" data-parent="#accordion">
                <div class="card-body">
                    <a href="<{$ATSAST_DOMAIN}>/course/<{$cid}>/view_homework/<{$syid}>/details/<{$h['uid']}>"><button type="button" class="btn btn-outline-primary">查看作业</button></a>
                </div>
            </div>
        </card>
        <{/foreach}>
