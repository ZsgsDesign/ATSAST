...
<div class="container mundb-standard-container">
    ...
    <card class="mb-3">
        ...
        <div>
            ...
            <p>
                <span class="d-block d-lg-inline-block"><i class="MDI clock"></i> {{ $syllabus_info['time'] }}</span>
                <span class="d-block d-lg-inline-block"><i class="MDI near-me"></i> {{ $syllabus_info['location'] }}</span>
            </p>
        </div>
