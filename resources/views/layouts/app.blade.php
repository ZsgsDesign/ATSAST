        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item />">
                        <a class="nav-link @if ($navigation === "Home") active @endif" href="{{$ATSAST_DOMAIN}}/">发现</a>
                    </li>
                    <li class="nav-item />">
                        <a class="nav-link @if ($navigation === "Courses") active @endif" href="{{$ATSAST_DOMAIN}}/course">课程</a>
                    </li>
                    <li class="nav-item />">
                        <a class="nav-link @if ($navigation === "Contests") active @endif" href="{{$ATSAST_DOMAIN}}/contest">活动</a>
                    </li>
                    <li class="nav-item />">
                ...
                <ul class="navbar-nav mundb-nav-right">
                    <li class="nav-item mundb-no-shrink />">
                        @guest
                            <a class="nav-link @if ($navigation === "Account") active @endif" href="{{$ATSAST_DOMAIN}}/login">登录 / 注册</a>
                        @else
