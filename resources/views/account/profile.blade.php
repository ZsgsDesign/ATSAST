    ...
    <div class="atsast-profile-container">
        <div class="atsast-left-panel">
            <div class="card mb-3 atsast-user-card">
                ...
                <div class="card-body text-right">
                    <a href="{{$ATSAST_DOMAIN}}/account/settings#user-info"><button class="btn btn-primary">修改基本信息</button></a>
                </div>
            </div>
        </div>
        <div class="atsast-right-panel d-none d-lg-block">
            <div class="atsast-title-panel">
                <div>
                    ...
                    <div class="atsast-title-acton">
                        <a href="{{$ATSAST_DOMAIN}}/account/settings#cover-image"><button type="button" class="btn btn-outline-light"><i class="MDI image-filter-hdr"></i> 修改封面</button></a>
                    </div>
                </div>
            </div>
            <card class="mb-3" id="user-info">
                ...
                @else
                    ...
                    <div class="col-lg-6 col-md-12 atsast-courses">
                        <a href="{{$ATSAST_DOMAIN}}/course/{{$r->cid}}/detail">
                            <course>
            ...
            <card class="mb-5" id="user-info">
                    ...
                    <div class="col-lg-6 col-md-12 atsast-courses">
                        <contest>
                            ...
                            <div class="atsast-content-container">
                                ...
                                <a href="{{$ATSAST_DOMAIN}}/contest/{{$c->contest_id}}/detail"><button class="btn btn-outline-info"><i class="MDI note"></i> 查看详情</button></a>
                                <a href="{{$ATSAST_DOMAIN}}/contest/{{$c->contest_id}}/register"><button class="btn btn-outline-warning"><i class="MDI pen"></i> 查看报名信息</button></a>
                            </div>
                        </contest>
                    </div>
                    @endforeach
                ...
                <div class="text-right mt-1">
                    <a href="{{$ATSAST_DOMAIN}}/account/contests/"><button class="btn btn-info">查看更多</button></a>
                </div>
            </card>
