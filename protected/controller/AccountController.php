...
class AccountController extends BaseController
{
    ...
    public function actionProfile()
    {
        ...
        foreach ($contest_result as &$r) {
            ...
            else if($r["parse_status"]==0) $r["parse_status"]='<span class="wemd-light-blue-text"><span><i class="MDI timer-sand"></i> 已提交报名</span>';
            else if($r["parse_status"]==0) $r["parse_status"]='<span class="wemd-red-text"><i class="MDI alert-circle-outline"></i> 报名已被拒绝</span>';
        }
