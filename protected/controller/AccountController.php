...
class AccountController extends BaseController
{
	...
	public static function sendActivateEmail($email_address,$OPENID,$ATSAST_DOMAIN){
		...
		$mail->AltBody    = "激活地址为：".$ATSAST_DOMAIN."/account/activate?act=".$OPENID."，请使用一个支持HTML视图的邮箱服务来查看本激活邮件！"; //当邮件不支持html时备用显示，可以省略
